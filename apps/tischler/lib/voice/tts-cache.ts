 ...
 * verwenden muss.
 *
 * crypto.subtle existiert NUR im Secure Context (https oder localhost). Die
 * Demo läuft aber auch über LAN-HTTP (Beamer-Laptop ruft den Demo-Rechner
 * per IP auf, Headset ohne adb) — dort übernimmt der pure-JS-Fallback
 * denselben SHA-256, sonst stirbt die komplette Stimm-Kette am Hash.
 */
...
// SHA-256 nach FIPS 180-4, pure JS. Nur Fallback für Insecure Contexts —
// im Secure Context rechnet immer crypto.subtle (nativ, schneller).
