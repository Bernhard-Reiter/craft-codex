import type { RAGDocument } from "@voai/lehrlings-core";
 ...
 * VOAI-Pro Variante kann spaeter weitere Lizenzklassen ergaenzen
 * (z.B. "barlieb-licensed" fuer kommerziell lizenzierte INNOS-Materialien).
 *
 * Schema folgt RAGDocument aus @voai/lehrlings-core.
 */
 ...
 * (default: OPEN_CORE_LICENSES). VOAI-Pro Variante kann spaeter weitere
