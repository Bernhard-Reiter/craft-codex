...
import type { DovetailStep, Pose } from "@voai/lehrlings-core";

const KEY_SESSION = "lehrling-edu:dovetail:session";
const KEY_PROGRESS = "lehrling-edu:dovetail:progress";
const KEY_MODES = "lehrling-edu:surface:modes";
const KEY_PLACEMENTS = "lehrling-edu:tracking:placements";
